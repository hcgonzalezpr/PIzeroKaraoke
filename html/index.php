...
<div data-role="page" id="home">
	...
	<div role="main" class="ui-content">
		<p><a href="#songlist" data-role="button" data-transition="fade" data-icon="search" data-iconpos="right">Search for a song</a></p>
		<p>
...
<div data-role="page" id="trackDialog">
	...
	<div data-role="content" data-theme="a">	
        ...
        <p><a href="#" onclick="window.queueSong();" data-role="button" data-theme="b" data-icon="plus" data-iconpos="right">Add to Queue</a></p>
...
<div data-role="page" id="songlist">
    ...
    <div data-role="header">
        <h1>Songs List <small>( <?php echo count($files); ?> songs )</small></h1>
    ...
    <div data-role="content">
		...
		<ul id="suggestionsa" data-role="listview" data-inset="true" data-input="#searchFieldA" data-filter="true">
		 <?php
